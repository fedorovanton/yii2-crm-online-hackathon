...
/**
 * Представление для виджета поиска участника
...
<!--<div class="searchbar">
    ...
    <div class="searchbar">
        <div class="searchbar__input">
            <div class="searchbar__icon"></div>
                <?php echo Select2::widget([
                    'name' => 'search',
                    'options' => ['placeholder' => 'Поиск по участникам...'],
                    'pluginOptions' => [
                        'allowClear' => true,
                        ...
                        'templateSelection' => new JsExpression('function (data) {
                            if (data.id>0) { window.location.href = "/member/update/" + data.id }
                            return data.text; 
                        }'),
                        'language' => [
