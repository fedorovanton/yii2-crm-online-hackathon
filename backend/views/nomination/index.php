...
/* @var $searchModel backend\models\Nomination\NominationSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Номинации | ' . Yii::$app->name;
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="members right-part">
    <div class="members__controls">
        <?= Html::a('<div class="control__text">Добавить номинацию</div>', ['create'], ['class' => 'members__control-link members__control--add'])?>
    </div>
