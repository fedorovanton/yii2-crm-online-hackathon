...
return [
    ...
    'region_residence' => [
        ...
        'value' => function ($model) {
            /** @var $model \frontend\models\MemberInfo\MemberInfo */
            return $model->memberUniversities->region_residence;
        }
    ],
    'team_id' => [
        'label' => 'Команда',
        ...
        'value' => function ($model) {
            /** @var $model \frontend\models\MemberInfo\MemberInfo */
            if ($model->memberUniversities->team) {
                return $model->memberUniversities->team->name;
            } else {
    ...
    /*[
        ...
        'value' => function ($model) {
            ...
            $team = $model->memberUniversities->team;
            if ($team) {
    ...
    'team_status' => [
        ...
        'value' => function ($model) {
            /** @var $model \frontend\models\MemberInfo\MemberInfo */
            return $model->memberUniversities->getTeamStatusName();
        }
    ],
    'check_status' => [
