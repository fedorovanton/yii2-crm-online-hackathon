...
return [
    ...
    'region_residence' => [
        ...
        'value' => function ($model) {
            /** @var $model \frontend\models\MemberInfo\MemberInfo */
            return $model->memberPupils->region_residence;
        }
    ],
    'team_id' => [
        'label' => 'Команда',
        ...
        'value' => function ($model) {
            /** @var $model \frontend\models\MemberInfo\MemberInfo */
            if ($model->memberPupils->team) {
                return $model->memberPupils->team->name;
            } else {
    ...
    'team_status' => [
        ...
        'value' => function ($model) {
            /** @var $model \frontend\models\MemberInfo\MemberInfo */
            return $model->memberPupils->getTeamStatusName();
        }
    ],
